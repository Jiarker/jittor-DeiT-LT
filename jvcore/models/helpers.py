...
from jvcore.layers import Conv2dSame, Linear
from jvcore.layers import Conv2dSame
_logger = logging.getLogger(__name__)

# def is_state_dict_key(state_dict_key, checkpoint):
...
def load_pretrained(model, default_cfg=None, num_classes=1000, in_chans=3, filter_fn=None, strict=True, progress=False):
    ...
    state_dict = load_state_dict_from_url(pretrained_url, progress=progress)
